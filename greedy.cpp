...
void calc_baseline(Graph& g, vector<vector<struct X>>& A, double diff_A_value, double cost_A, double* baseline_table[U_LENGTH], bool X_in_set_A[U_LENGTH], int sample_size){
    int one_dim_idx=0;
