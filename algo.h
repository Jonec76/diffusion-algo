...
void calc_main(Graph& g, vector<vector<struct X> >& A, double prev_best_A, double cost_A, double* diff_baseline_table[], bool X_in_set_A[], int sam_size);
void calc_greedy(Graph& g, vector<vector<struct X> >& A, double prev_best_A, double cost_A, double* diff_baseline_table[], bool X_in_set_A[], int sam_size);
